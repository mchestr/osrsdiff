...
from src.workers.scheduler import TaskScheduler, get_scheduler, start_scheduler, stop_scheduler
...
class TestTaskScheduler:
    ...
    def mock_redis(self):
        ...
        mock_redis.set.return_value = True  # Lock acquisition succeeds by default
    ...
    def scheduler(self):
        ...
        return TaskScheduler(fetch_interval_minutes=1)  # Short interval for testing
    ...
    async def test_scheduler_loop_execution(self, scheduler, mock_redis):
        ...
        with patch('src.workers.scheduler.process_scheduled_fetches_task') as mock_task:
    ...
    async def test_next_run_calculation(self, scheduler):
        ...
        expected_next = scheduler._last_scheduled_run + scheduler.fetch_interval
    ...
    @pytest.mark.asyncio
    async def test_redis_lock_release_error_handling(self, scheduler, mock_redis):
