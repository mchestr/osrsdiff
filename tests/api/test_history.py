...
from src.api.history import router, get_history_service
...
class TestHistoryEndpoints:
    ...
    def test_get_player_history_success_with_dates(self, client, mock_history_service):
    ...
    def test_get_player_history_success_with_days(self, client, mock_history_service):
    ...
    def test_get_player_history_default_30_days(self, client, mock_history_service):
    ...
    def test_get_player_history_invalid_date_format(self, client, mock_history_service):
    ...
    def test_get_player_history_start_after_end(self, client, mock_history_service):
    ...
    def test_get_player_history_date_range_too_large(self, client, mock_history_service):
    ...
    def test_get_player_history_player_not_found(self, client, mock_history_service):
        """Test handling of non-existent player."""
        mock_history_service.get_progress_between_dates.side_effect = PlayerNotFoundError(
    ...
    def test_get_player_history_insufficient_data(self, client, mock_history_service):
        """Test handling of insufficient data error."""
        mock_history_service.get_progress_between_dates.side_effect = InsufficientDataError(
            "Insufficient data for progress analysis"
        )
    ...
    def test_get_player_history_service_error(self, client, mock_history_service):
        """Test handling of history service errors."""
        mock_history_service.get_progress_between_dates.side_effect = HistoryServiceError(
    ...
    def test_get_skill_progress_success(self, client, mock_history_service):
        ...
        player = create_test_player(1, "test_player")
        records = [
            create_test_hiscore_record(1, player, datetime.now(timezone.utc) - timedelta(days=7)),
    ...
    def test_get_skill_progress_default_days(self, client, mock_history_service):
    ...
    def test_get_skill_progress_invalid_days(self, client, mock_history_service):
    ...
    def test_get_skill_progress_days_too_large(self, client, mock_history_service):
    ...
    def test_get_skill_progress_empty_skill_name(self, client, mock_history_service):
    ...
    def test_get_skill_progress_player_not_found(self, client, mock_history_service):
        """Test skill progress for non-existent player."""
        mock_history_service.get_skill_progress.side_effect = PlayerNotFoundError(
            "Player 'nonexistent' not found"
        )
    ...
    def test_get_skill_progress_insufficient_data(self, client, mock_history_service):
        """Test skill progress with insufficient data."""
        mock_history_service.get_skill_progress.side_effect = InsufficientDataError(
    ...
    def test_get_boss_progress_success(self, client, mock_history_service):
        ...
        player = create_test_player(1, "test_player")
        records = [
            create_test_hiscore_record(1, player, datetime.now(timezone.utc) - timedelta(days=14)),
            create_test_hiscore_record(2, player, datetime.now(timezone.utc)),
        ]
    ...
    def test_get_boss_progress_default_days(self, client, mock_history_service):
    ...
    def test_get_boss_progress_empty_boss_name(self, client, mock_history_service):
    ...
    def test_get_boss_progress_player_not_found(self, client, mock_history_service):
        """Test boss progress for non-existent player."""
        mock_history_service.get_boss_progress.side_effect = PlayerNotFoundError(
            "Player 'nonexistent' not found"
        )
    ...
    def test_get_boss_progress_insufficient_data(self, client, mock_history_service):
        """Test boss progress with insufficient data."""
        mock_history_service.get_boss_progress.side_effect = InsufficientDataError(
    ...
    def test_authentication_required_history(self, client, mock_history_service):
    ...
    def test_authentication_required_skill_progress(self, client, mock_history_service):
    ...
    def test_authentication_required_boss_progress(self, client, mock_history_service):
