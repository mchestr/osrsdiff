...
from src.api.players import router, get_player_service
...
from src.services.osrs_api import PlayerNotFoundError as OSRSPlayerNotFoundError, OSRSAPIError


def create_test_player(id: int, username: str, is_active: bool = True, fetch_interval_minutes: int = 60):
...
class TestPlayerEndpoints:
    ...
    def test_add_player_invalid_username(self, client, mock_player_service):
        ...
        mock_player_service.add_player.side_effect = InvalidUsernameError("Invalid username format")
    ...
    def test_add_player_already_exists(self, client, mock_player_service):
        ...
        mock_player_service.add_player.side_effect = PlayerAlreadyExistsError("Player already exists")
    ...
    def test_add_player_not_found_in_osrs(self, client, mock_player_service):
        ...
        mock_player_service.add_player.side_effect = OSRSPlayerNotFoundError("Player not found in OSRS")
    ...
    def test_add_player_osrs_api_error(self, client, mock_player_service):
        ...
        mock_player_service.add_player.side_effect = OSRSAPIError("OSRS API unavailable")
    ...
    def test_remove_player_success(self, client, mock_player_service):
        ...
        response = client.delete("/players/test_player", headers={
        ...
        # Verify service was called correctly
        mock_player_service.remove_player.assert_called_once_with("test_player")
    ...
    def test_remove_player_not_found(self, client, mock_player_service):
        ...
        response = client.delete("/players/nonexistent_player", headers={
            "Authorization": "Bearer fake_token"
        })
    ...
    def test_list_players_success(self, client, mock_player_service):
        ...
        # Verify service was called correctly
        mock_player_service.list_players.assert_called_once_with(active_only=True)
    ...
    def test_list_players_include_inactive(self, client, mock_player_service):
        ...
        response = client.get("/players?active_only=false", headers={
            "Authorization": "Bearer fake_token"
        })
        ...
        # Verify service was called correctly
        mock_player_service.list_players.assert_called_once_with(active_only=False)
    ...
    def test_add_player_missing_username(self, client, mock_player_service):
        ...
        response = client.post("/players", json={}, headers={
            "Authorization": "Bearer fake_token"
        })
    ...
    def test_trigger_manual_fetch_success(self, mock_task, client, mock_player_service):
        ...
        response = client.post("/players/test_player/fetch", headers={
            "Authorization": "Bearer fake_token"
        })
    ...
    @patch('src.workers.tasks.fetch_player_hiscores_task')
    def test_trigger_manual_fetch_player_not_found(self, mock_task, client, mock_player_service):
        """Test manual fetch trigger for non-existent player."""
        mock_player_service.get_player.return_value = None
        
        response = client.post("/players/nonexistent/fetch", headers={
            "Authorization": "Bearer fake_token"
        })
    ...
    @patch('src.workers.tasks.fetch_player_hiscores_task')
    def test_trigger_manual_fetch_task_enqueue_error(self, mock_task, client, mock_player_service):
