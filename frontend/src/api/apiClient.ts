...
export const api = {
  ...
  PlayersService: {
    ...
    recalculateGameModeApiV1PlayersUsernameRecalculateGameModePost: (username: string) =>
      handleTokenRefresh(() => PlayersService.recalculateGameModeApiV1PlayersUsernameRecalculateGameModePost(username)),
